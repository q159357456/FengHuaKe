...
@interface PhotoContainerView()<PhotoBrowserDelegate,QMUIImagePreviewViewDelegate>
...
//        }
    ...
    [_picPathStringsArray enumerateObjectsUsingBlock:^(NSString *  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        imageView.hidden = NO;
        [imageView sd_setImageWithURL:[NSURL URLWithString:[DataProcess PicAdress:obj]] placeholderImage:[UIImage imageNamed:@"placeHolder"]];
