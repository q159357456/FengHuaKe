...
+(NSString *)getMinceDataWithStr:(NSString *)str
{
    NSDate *nowDate=[NSDate date];
    
    NSDate *creat=[NSDate date:str WithFormat:@"YYYY-MM-dd HH:mm:ss"];
    NSInteger miniute=[creat minutesBeforeDate:nowDate];
//    NSLog(@"%ld",miniute);
    if (miniute>0)
    {
        //转换
        ...
        NSString*day=[NSString stringWithFormat:@"%ld",minceDay];
        NSString*hour=[NSString stringWithFormat:@"%ld",minceHoure];
        NSString*minute=[NSString stringWithFormat:@"%ld",minceMinuite];
        if (day.integerValue>0)
        {
            ...
            }else
            {
                ...
                return [NSString stringWithFormat:@"%@天之前",day];
            }
        ...
        }else
        {
            if (hour.integerValue>0)
            {
                ...
                return [NSString stringWithFormat:@"%@小时之前",hour];
                
            }else
            {
                
                return [NSString stringWithFormat:@"%@分钟之前",minute];
            }
        }
